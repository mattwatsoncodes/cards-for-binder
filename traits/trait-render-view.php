...
trait Helper_Render_View {
	...
	public static function render_view( $file_name ) {
		...
		$view_template_folder              = apply_filters( MKDO_CARDS_FOR_BINDER_PREFIX . '_view_template_folder', '' );
		$view_template_folder_check_exists = apply_filters( MKDO_CARDS_FOR_BINDER_PREFIX . '_view_template_folder_check_exists', false );
