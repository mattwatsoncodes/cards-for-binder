...
class Notices_Admin {
	...
	public function admin_notices() {
		...
		if ( ! class_exists( 'mkdo\binder\Controller_Main' ) ) {
			...
			$warning = sprintf( __( 'The %1$sCards for Binder%2$s plugin works much better when you %3$sinstall and activate the Binder plugin%4$s.', 'cards-for-binder' ), '<strong>', '</strong>', '<a href="' . $url . '" target="_blank">', '</a>' );
			?>
